...
3. **Claude — Spec Review:** reads the relevant repository specs and reviews ambiguity, contradictions, missing acceptance criteria, technical implementability and hidden assumptions. Claude is a reviewer/refiner, not product authority.
4. Human/product review resolves Claude findings. Specs are corrected when required.
5. **Lovable — Plan Mode:** reads the approved specs and proposes an implementation plan **without coding**.
...
7. Any material gap returns to Specs and, when useful, Claude review / Lovable Plan again.
